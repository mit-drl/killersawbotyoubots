...
rospy.init_node('wing_transport_master_dynamic')
...
try:
  ...
  if do_first_hole:
      ...
      # distributed_cmd('open_gripper',[robot['carry'][1]],ack_carry1)
      # distributed_cmd('back_away',[robot['carry'][1]],ack_carry1)
      #raw_input("Hit Enter to lift tool up.\n")
      #distributed_cmd('LiftTool', robot['fine_perception'], ack_fine, 'Fastener number 1 installed.')
      # distributed_insert_cmd('LiftTool', robot['fine_perception'], ack_fine, 0., 'hole_1', "Fastener number 1 installed.", bubbles=False)
  ...
  if new_2nd_hole_alignment:
      ...
      # TODO move drc1 to left (CHANGHYUN)
      # TODO stop when holes are aligned
      # TODO Maybe insert?
      # TODO drc1 releases wing panel
  else:
