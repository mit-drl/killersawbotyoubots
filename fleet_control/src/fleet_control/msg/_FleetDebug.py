"""autogenerated by genpy from fleet_control/FleetDebug.msg. Do not edit."""
import sys
...
class FleetDebug(genpy.Message):
  _md5sum = "420cd38b6b071cd49f2970c3e2cee511"
  _type = "fleet_control/FleetDebug"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FleetDebug, self).__init__(*args, **kwds)
