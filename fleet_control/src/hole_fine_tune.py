...
try:
  ...
  if do_first_hole:
      ...
      #  c = raw_input('Displace robot. Then cmd: q for quit')
      #  if c == 'q':
      #     break
      #raw_input('hit enter')
  ...
  if new_2nd_hole_alignment:
      ...
      while not rospy.is_shutdown():
        ...
        raw_input('align hole. hit enter.')
        if usehokuyo:
